    ...
    return (
        <div className="col">
            <div className="card" style={{ height: "380px", position: 'relative', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', overflow: 'hidden' }}>
                ...
                <i className={wishList.some((p) => p.id === product.id) ? "fa-solid fa-heart" : "fa-regular fa-heart"} style={{ position: 'absolute', top: '10px', right: '10px', fontSize: '24px', color: 'red', cursor: 'pointer' }} onClick={() => addToWishList(product)}></i>
                ...
                <div className="card-body d-flex flex-column" style={{ padding: '15px', height: '100%' }}>
                    ...
                    <div className="d-flex justify-content-between align-items-center" style={{ marginTop: 'auto' }}>
                        ...
                        <i className="fa-solid fa-cart-plus" style={basket.some((p) => p.id === product.id) ? { fontSize: '24px', color: 'green', cursor: 'pointer' } : { fontSize: '24px', color: '#007bff', cursor: 'pointer' }} onClick={() => addToBasket(product)}></i>
                    </div>
                </div>
            </div>
        </div>
